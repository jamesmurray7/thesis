...
load("/data/c0061461/THESIS/GMVJM/data/Triv_eg.RData")
...
fitfn <- function(data, MCtype){
  fit <- tryCatch(suppressWarnings(
    joint(long.formulas = long.formulas, surv.formula = surv.formula,
          ...
          disp.formulas = disp.formulas, MCtype = MCtype, N = 300,
...
save(MCfits, file = "/data/c0061461/THESIS/gmvjoint-MC/fitsMC.RData")
