...
\begin{figure}[ht]
    \centering
    \includegraphics{Figures_PBCApplication/biv2-qqnorm-corrections.png}
...
\subsection{Quantile-quantile plot of random effects from final model}\label{sec:appendix-suppfigs-finalQQ-REs}
...
\begin{figure}[ht]
    \centering
    \includegraphics{Figures_PBCApplication/biv2-qqnorm-REs-corrections.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=130mm]{Figures_PBCApplication/biv2-postb-corrections.png}
