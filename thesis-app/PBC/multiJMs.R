...
source(".Rprofile")
source("helpers.R")
save.dir <- save.dir.file.path("Joint")
library(splines)
...
Ps$Surv
ggsave(save.dir.file.path("GaussiansSurv.png", save.dir),
       width = 140, height = 90, units = "mm")
# and the longitudinals in appendix.
Ps$Long
ggsave(save.dir.file.path("GaussiansLong.png", save.dir),
...
Pc$Surv
ggsave(save.dir.file.path("CountsSurv.png", save.dir),
       width = 140, height = 90, units = "mm")
Pc$Long
ggsave(save.dir.file.path("CountsLong.png", save.dir),
       width = 140, height = 90, units = "mm")
...
PC.Disps$Surv
ggsave(save.dir.file.path("DispCountsSurv.png", save.dir),
       width = 140, height = 90, units = "mm")
PC.Disps$Long
ggsave(save.dir.file.path("DispCountsLong.png", save.dir),
...
Pconts$Surv
ggsave(save.dir.file.path("ContsSurv.png", save.dir),
       width = 140, height = 90, units = "mm")
Pconts$Long
ggsave(save.dir.file.path("ContsLong.png", save.dir),
       width = 140, height = 180, units = "mm")
...
Pconts.reduced$Surv
ggsave(save.dir.file.path("ContsReducedSurv.png", save.dir),
       width = 140, height = 90, units = "mm")
Pconts.reduced$Long
ggsave(save.dir.file.path("ContsReducedLong.png", save.dir),
       width = 140, height = 90, units = "mm")
...
save(fin, file = save.dir.file.path("fin.RData", save.dir))
...
save(fin2, file = save.dir.file.path("fin2.RData", save.dir))
# Looks better!!!

fin2.cc <- cond.ranefs(fin2, tune = .425)
png(filename = save.dir.file.path("test.png", save.dir), # same as earlier plots really...
...
Pfin2$Surv
ggsave(save.dir.file.path("fin2Surv.png", save.dir),
       width = 140, height = 90, units = "mm")
Pfin2$Long
ggsave(save.dir.file.path("fin2Long.png", save.dir),
